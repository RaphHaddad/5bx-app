...
class Exercise extends React.Component<ExerciseProps, ExerciseState> {
    ...
    private setRepsAndImage() {
        ...
        let levels = charts.filter((chart) => chart.chartNumber === this.props.chart)[0].levels;
    }
}
...
class Level {
    constructor(public levels: string, public exercise1Reps: number, public exercise2Reps: number, public exercise3Reps: number, public exercise4Reps: number, public exercise5Reps: number) {
